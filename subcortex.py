...
async def gather_subdomains(domain):
    ...
    VT_API_KEY = 'ba30b28fe2a2c348de58127b68447013f73577a383c9ec0a5be86579647881a7'
    ...
    commands = [
        (f'''curl --socks5 127.0.0.1:9050 -s --request GET --url 'https://api.securitytrails.com/v1/domain/{domain}/subdomains?children_only=true&include_inactive=false' --header 'APIKEY: ljqY4uM2ckHzMbO3_w4vV1Wn_5KI150w' --header 'accept: application/json' | jq -r '.subdomains[] | . + ".{domain}"' | anew securitytrails''', "Collecting subdomains from SecurityTrails"),
        ...
        (f'''curl --socks5 127.0.0.1:9050 -s "https://anubisdb.com/anubis/subdomains/{domain}" | jq -r '.[]' | sort -u | anew jldc''', "Collecting subdomains from JLDC API"),
...
async def abuseipdb(domain, session):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from AbuseIPDB\033[0m")
...
async def alienvault(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from AlienVault\033[0m")
...
async def anubis(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Anubis\033[0m")
...
async def crtsh(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from crt.sh\033[0m")

    url = f"https://crt.sh/?q=%25.{domain}&output=json"
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36",
        "Accept": "application/json",
        "Referer": f"https://crt.sh/?q=%25.{domain}&output=json"
    }
    ...
    while retries < max_retries:
        try:
            async with session.get(url, timeout=1000, headers=headers) as response:
                if response.status != 200:
                ...
                for entry in data:
                    ...
                    subdomains.extend(name_value.splitlines())
...
async def dnsrepo(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Dnsrepo\033[0m")
...
async def hackertarget(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31mCollecting subdomains from HackerTarget\033[0m")  # Bilgilendirme mesajı
...
async def myssl(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from MySSL\033[0m")
...
async def racent(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Racent\033[0m")
...
async def rapiddns(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from RapidDNS\033[0m")
...
async def shodan(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Shodan\033[0m")
...
async def shrewdeye(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from ShrewdEye\033[0m")
...
async def sitedossier(domain, session):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from SiteDossier\033[0m")
...
async def subdomaincenter(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Subdomain Center\033[0m")
...
async def urlscan(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Urlscan\033[0m")
...
async def waybackarchive(domain, session, args):
    print(f"\033[34mINFO:\033[0m \033[31m Collecting subdomains from Wayback Archive\033[0m")
